...
export function ChatInputProvider({
	...
	const [selectedModelId, setSelectedModelId] = useState<ModelId>(overrideModelId || defaultModel)

	const [selectedTool, setSelectedTool] = useState<UiToolName | null>(initialTool)
