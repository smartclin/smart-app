...
async function main() {
  ...
  const _workingDays = await db.workingDays.createMany({
  ...
  const _vitalSigns = await db.vitalSigns.createMany({
    data: vitalSignsData
  });
  ...
  const _diagnosis = await db.diagnosis.createMany({ data: diagnosisData });
  ...
  const _patientBills = await db.patientBills.createMany({
  ...
  const _labTests = await db.labTest.createManyAndReturn({
    data: labTestsData
  ...
  const _prescriptions = await db.prescription.createMany({
  ...
  const _vaccinations = await db.vaccination.createMany({
  ...
  const _auditLogs = await db.auditLog.createMany({ data: auditLogsData });
  ...
  const _ratings = await db.rating.createMany({ data: ratingsData });
  ...
  const _whoGrowthStandard = await db.wHOGrowthStandard.createMany({
