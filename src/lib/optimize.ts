...
const nextConfig: NextConfig = {
  ...
  eslint: {
    ...
    dirs: ['app', 'lib', 'components', 'server'], // Specify directories to lint
  },
  ...
  experimental: {
    ...
    // Package import optimizations - expanded for your stack [^1]
...
const withNextIntl = createNextIntlPlugin('./lib/i18n.ts') // Adjust path as needed
