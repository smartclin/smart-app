...
export type TOpenAIModelResponseSchema = z.infer<
  typeof OpenAIModelResponseSchema
>
...
export const AnthropicModelsResponseSchema = z.array(
  AnthropicModelResponseSchema,
)
export type TAnthropicModelResponseSchema = z.infer<
  typeof AnthropicModelResponseSchema
>
...
export type TLocalCompletionsRequest = z.infer<
  typeof LocalCompletionsRequestSchema
>
...
export type TGoogleModelResponseSchema = z.infer<
  typeof GoogleModelResponseSchema
>
...
export type TGoogleChatCompletionRequestSchema = z.infer<
  typeof GoogleChatCompletionRequestSchema
>
export type TGoogleChatCompletionResponseSchema = z.infer<
  typeof GoogleChatCompletionResponseSchema
>
...
export const OpenRouterModelsResponseSchema = z.array(
  OpenRouterModelResponseSchema,
)
...
export const ProviderSettingsSchema = z.object({
  ...
  url: z
    ...
    .regex(
      urlPattern,
      "URL must start with 'http://' or 'https://' followed by a domain name.",
    ),
  apiType: z
    .string({ error: 'Please select the api type.' })
    .min(2, 'Please select the api type.'),
  apiKey: z
    .union([
      z.string().min(5, 'API Key must be at least 5 characters long.'),
      z.literal(''),
    ])
    .optional(),
})
...
export type TProviderSettingsFormSchema = z.infer<
  typeof ProviderSettingsFormSchema
>
