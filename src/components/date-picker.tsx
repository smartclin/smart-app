        ...
        <Calendar
            ...
            classNames={{
                ...
                day: cn(
                    ...
                    isDayView && '[&[aria-selected="true"]>button]:bg-sidebar-foreground/4 dark:[&[aria-selected="true"]>button]:bg-sidebar-foreground/8',
                ),
                // Today styling needs to target the day that has the `data-today` attribute
                day_today: cn( // This typically targets the today's day button
